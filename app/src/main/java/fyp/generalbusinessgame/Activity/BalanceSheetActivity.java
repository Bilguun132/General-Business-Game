...
import fyp.generalbusinessgame.Models.GameBalanceSheetModel;
 ...
 */
public class BalanceSheetActivity extends AppCompatActivity implements DownloadCallback<HttpResult> {
    /**
                ...
                if (mDownloadTarget == 1) {
                    switch (result.responseCode) {
                        case 200:
                            ...
                            GameBalanceSheetModel gameBalanceSheetModel = gson.fromJson(result.responseBody, GameBalanceSheetModel.class);
                            EditText asset = (EditText) findViewById(R.id.balance_sheet_asset_number);
                            asset.setText(gameBalanceSheetModel.totalAsset);
                            EditText liability = (EditText) findViewById(R.id.balance_sheet_liabilities_number);
                            liability.setText(gameBalanceSheetModel.totalLiability);
                            EditText equity = (EditText) findViewById(R.id.balance_sheet_equity_number);
                            equity.setText(gameBalanceSheetModel.totalEquity);
                    }
                }
            }
        }
    ...
    public void finishInitializing() {
        ...
        httpRequest.urlPath = getString(R.string.get_balance_sheet_by_firm_id) + firmId;
